function JWPlayer() {
    ...
    function startvideo() {
        skipped = false;
		console.log(properties.watermarkfile);
        playerInstance = jwplayer(properties.playername).setup({
            "playlist": playlist,
			"visualplaylist":properties.visualplaylist,
			"nextUpDisplay":properties.nextUpDisplay,
            ...
            "screencolor": "0f0f0f",
			"logo": {
				"file": properties.watermarkfile,
				"link": properties.watermarklink,
				"hide": properties.watermarkhide,
				"position": properties.watermarkposition,
				"margin": properties.watermarkmargin
			  }
        });
        if (properties.videotype == 'slider') {
            jwplayer(properties.playername).on('play', function(event) {
