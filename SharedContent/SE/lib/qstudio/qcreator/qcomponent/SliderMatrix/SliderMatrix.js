    ...
    SliderMatrix.prototype = {
        ...
        dimensions: function() {
            return [
                { name:"rowArray", prop:[
                    ...
                    "end_labels"        // Row slider end labels
                ] },
        ...
        initParams: function() {
            return {
                ...
                colContainType: { name:"Column Contain: Layout Type", value:"horizontal layout", description:"Layout template applied to column sliders and buttons.", type:"combo", options:["horizontal grid layout", "vertical grid layout", "horizontal layout", "vertical layout"], order: 3 },
                ...
                colContainHgap: { name:"Column Contain: Horz Btn Spacing", value:10, description:"The horizontal spacing of column sliders and buttons, in pixels.", type:"number", wgtref: 'colcontain', wgtname:"hgap", order: 8 },
                colContainVgap: { name:"Column Contain: Vert Btn Spacing", value:10, description:"The vertical spacing of column sliders and buttons, in pixels.", type:"number", wgtref: 'colcontain', wgtname:"vgap", order: 9 },
                ...
                colSldrBorderStyle: { name:"Slider: Border Style", value:"none", description:"Slider CSS border style.", type:"combo", options:["solid", "dotted", "dashed", "none"], wgtref: 'colsldr', wgtname:"widget_border_style", order: 12 },
                colSldrBorderWidth: { name:"Slider: Border Width", value:2, description:"Slider border width, in pixels.", type:"number", min:0, wgtref: 'colsldr', wgtname:"widget_border_width", order: 13 },
                colSldrBorderColor: { name:"Slider: Border Color", value:0xd2d3d5, description:"Slider border color.", type:"colour", wgtref: 'colsldr', wgtname:"widget_border_color", order: 14 },
                ...
                colSldrMinVal: { name:"Slider: Min Range Value", value:0, description:"Minimum slider range value.", type:"number", wgtref: 'colsldr', wgtname:"min", order:70, display: false },
                colSldrMaxVal: { name:"Slider: Max Range Value", value:100, description:"Maximum slider range value.", type:"number", wgtref: 'colsldr', wgtname:"max", order:71, display: false },
                colSldrPrecVal: { name:"Slider: Range Precision Value", value:0, description:"Slider range precision value.", type:"number", min:0, wgtref: 'colsldr', wgtname:"precision", order:72, display: false },
                colSlderAllowTrackClick: { name:"Slider Track: Allow Click", value:true, description:"If set true, users can interact w/ the slider track to move the handle.", type:"bool", wgtref: 'colsldr', wgtname:"allow_track_click", order:112 },
                ...
                colSldrTrackBorderColor: { name:"Slider Track: Border Color", value:0xd2d3d5, description:"Track border color.", type:"colour", wgtref: 'colsldr', wgtname:"track_border_color", order:78 },
                colSldrTrackColor: { name:"Slider Track: Bckgrnd Color", value:0xFFFFFF, description:"Track background color.", type:"colour", wgtref: 'colsldr', wgtname:"track_color", order:79 },
                ...
                colSldrShowHighlight: { name:"Slider Highlight: Display", value:true, description:"If set true, slider highlight scale will display.", type:"bool", wgtref: 'colsldr', wgtname:"show_highlight", order:82 },
                colSldrHighlightColor: { name:"Slider Highlight: Color", value:0xd2d3d5, description:"Track highlight color.", type:"colour", wgtref: 'colsldr', wgtname:"highlight_color", order:83 },
                colSldrTickShow: { name:"Slider Tick: Display", value:true, description:"If set true, slider ticks will display.", type:"bool", wgtref: 'colsldr', wgtname:"tick_show", order:80 },
                ...
                colSldrTickLabDispType: { name:"Slider Tick: Label Display Type", value:"row ends", description:"Track tick label display type.", type:"combo", options:["show none", "show all", "show ends", "show three", "custom", "row ends"], wgtref: 'colsldr', wgtname:"ticklabel_display_type", order:87 },
                colSldrTickLabCustomCnt: { name:"Slider Tick: Custom Label Count", value:3, description:"Number of tick labels to display on slider track. Applies to 'custom' tick label display type only.", type:"number", min:1, order:36 }, //excluded
                ...
                colSldrTickLabOffset: { name:"Slider Tick: Label Offset", value:0, description:"For 'horizontal' slider direction, top CSS offset position. For 'vertical' slider direction, left CSS offset position. (both in pixels)", type:"number", wgtref: 'colsldr', wgtname:"ticklabel_offset", order:89 },
                ...
                colSldrHndleShowImg: { name:"Slider Handle: Show Row Image", value:false, description:"If set true, row image will display on slider handle.", type:"bool", order:112 }, //excluded
                ...
                colSldrHndleInitLoc: { name:"Slider Handle: Start Loc", value:0, description:"Slider handle starting position. Number is percent based so 50 would represent the halfway point of the slider track w/ 0 and 100 being the endpoints. ", type:"number", min:0, max:100, wgtref: 'colsldr', wgtname:"handle_start_loc", order:93 },
                colSldrHndleWidth: { name:"Slider Handle: Bckgrnd Width", value:50, description:"Slider handle background width, in pixels.", type:"number", min:5, wgtref: 'colsldr', wgtname:"handle_width", order:94 },
                colSldrHndleHeight: { name:"Slider Handle: Bckgrnd Height", value:50, description:"Slider handle background height, in pixels.", type:"number", min:5, wgtref: 'colsldr', wgtname:"handle_height", order:95 },
                ...
                colSldrHndleBorderStyle: { name:"Slider Handle: Border Style", value:"solid", description:"Slider handle CSS border style.", type:"combo", options:["solid", "dotted", "dashed", "none"], wgtref: 'colsldr', wgtname:"handle_border_style", order:96 },
                ...
                colSldrHndleBorderColorUp: { name:"Slider Handle: Border UP Color", value:0xd2d3d5, description:"Slider handle border color in its default state.", type:"colour", wgtref: 'colsldr', wgtname:"handle_border_color_up", order:99 },
                colSldrHndleBorderColorDown: { name:"Slider Handle: Border DOWN Color", value:0xffbd1a, description:"Slider handle border color on select.", type:"colour", wgtref: 'colsldr', wgtname:"handle_border_color_down", order:99 },
                colSldrHndleColorUp: { name:"Slider Handle: Bckgrnd UP Color", value:0xFFFFFF, description:"Slider handle background color in its default state.", type:"colour", wgtref: 'colsldr', wgtname:"handle_color_up", order:100 },
                colSldrHndleColorDown: { name:"Slider Handle: Bckgrnd DOWN Color", value:0xFFFFFF, description:"Slider handle background color on select.", type:"colour", wgtref: 'colsldr', wgtname:"handle_color_down", order:101 },
                colSldrHndleShowImp: { name:"Slider Handle: Show Import Image", value:false, description:"If set true, imported slider handle image will display.", type:"bool", wgtref: 'colsldr', wgtname:"show_handle_import", order:102 },
                ...
                colSldrHndleLabDispType: { name:"Slider Handle: Label Display Type", value:"column label", description:"Slider handle label display type.", type:"combo", options:["column value", "column label", "range value", "none"], wgtref: 'colsldr', wgtname:"handle_label_disptype", order:105 },
                colSldrHndleLabFontSize: { name:"Slider Handle: Label Font Size", value:16, description:"Slider handle label font size, in pixels.", type:"number", min:5, wgtref: 'colsldr', wgtname:"handle_label_fontsize", order:106 },
                ...
                colSldrHndleShowLabelBckgrnd: { name:"Slider Handle: Label Bckgrnd Display", value:false, description:"If set true, handle label background will display.", type:"bool", wgtref: 'colsldr', wgtname:"show_handle_label_bckgrnd", order:112, display: false },
                ...
                colSldrHndleLabHoffset: { name:"Slider Handle: Label Left CSS Pos", value:0, description:"Left CSS offset position, in pixels.", type:"number", wgtref: 'colsldr', wgtname:"handle_label_left", order:110 },
                colSldrHndleLabVoffset: { name:"Slider Handle: Label Top CSS Pos", value:0, description:"Top CSS offset position, in pixels.", type:"number", wgtref: 'colsldr', wgtname:"handle_label_top", order:111 },
                colSldrImgDispType: { name:"Slider Image: Display Type", value:'none', description:"Image container display type.", type:"combo", options:['top', 'bottom', 'right', 'left', "none"], wgtref: 'colsldr', wgtname:"img_placement", order:40 },
                colSldrImgAutoCenter: { name:"Slider Image: Auto Center", value:true, description:"If set true, image container will horizontally/vertically center w/ the slider track.", type:"bool", wgtref: 'colsldr', wgtname:"img_auto_center", order:112 },
                colSldrShowInitImg: { name:"Slider Image: Show Initial Image", value:false, description:"If set true, initial image will display within the image container.", type:"bool", wgtref: 'colsldr', wgtname:"show_init_img", order:112 },
                colSldrImgContWidth: { name:"Slider Image: Width", value:100, description:"Image container width, in pixels.", type:"number", min:10, wgtref: 'colsldr', wgtname:"img_width", order:113 },
                colSldrImgContHeight: { name:"Slider Image: Height", value:100, description:"Image container height, in pixels.", type:"number", min:10, wgtref: 'colsldr', wgtname:"img_height", order:114 },
                colSldrImgContHoffset: { name:"Slider Image: Left CSS Pos", value:0, description:"Left CSS offset position, in pixels.", type:"number", wgtref: 'colsldr', wgtname:"img_left", order:115 },
                colSldrImgContVoffset: { name:"Slider Image: Top CSS Pos", value:0, description:"Top CSS offset position, in pixels.", type:"number", wgtref: 'colsldr', wgtname:"img_top", order:116 },
                colSldrShowEndImg: { name:"Slider End Image: Display", value:false, description:"If set true, end images will display left/right or top/bottom of the slider track. ", type:"bool", wgtref: 'colsldr', wgtname:"show_end_img", order:112 },
                colSldrImgEndWidth: { name:"Slider End Image: Width", value:100, description:"End image width, in pixels.", type:"number", min:10, wgtref: 'colsldr', wgtname:"end_img_width", order:113 },
                colSldrImgEndHeight: { name:"Slider End Image: Height", value:100, description:"End image height, in pixels.", type:"number", min:10, wgtref: 'colsldr', wgtname:"end_img_height", order:114 },
                colSldrImgEndHoffset: { name:"Slider End Image: Left CSS Pos", value:0, description:"Left CSS offset position, in pixels.", type:"number", wgtref: 'colsldr', wgtname:"end_img_left", order:115 },
                colSldrImgEndVoffset: { name:"Slider End Image: Top CSS Pos", value:0, description:"Top CSS offset position, in pixels.", type:"number", wgtref: 'colsldr', wgtname:"end_img_top", order:116 },
        ...
        __setColumnSldrLevelParams: function(colObject, wgtNameObj) {
            var paramNameObj = this.getColumnSldrParams();
            for (var key in colObject) {
                if (colObject.hasOwnProperty(key)) {
                    if (paramNameObj.hasOwnProperty(key)) {
                        if (!paramNameObj[key].wgtexclude) {
        ...
        __createDefaultMatrix: function() {
            ...
            if (QUtility.ieVersion() <= 9) { txtEvent = "keyup.slidermatrix"; }
        ...
        __updateDefaultMatrix: function(init) {
            ...
            var that = this,
                ...
                j = 0, blen = this.qStudioVar.btnArray.length,
                curSetIndex = 0;

            // helper function to return tick label array
            var getTickLabelArray = function(configObj) {
                // Create slider tick labels
                var sldrTickLabDispType = configObj.ticklabel_display_type.toLowerCase(),
                    ...
                    tickIncrem = (numOfTicks > 1) ? (that.qStudioVar.sliderArray.length - 1)/(numOfTicks - 1) : 1,
                    overrideTicks = ((sldrTickLabDispType === "custom" || sldrTickLabDispType === "show three" || sldrTickLabDispType === "row ends") && (tickIncrem >= 1)),
                    tickLabArray = [];
                console.log(that.qStudioVar.sliderArray.length)

                if (overrideTicks) {
                    // first clear all tick labels
                    for (var k = 0; k < that.qStudioVar.sliderArray.length; k += 1) {
                        tickLabArray[k] = { label: "", image: that.qStudioVar.sliderArray[k].image };
                    }

                    // then add the ones necessary
                    if (sldrTickLabDispType !== "row ends") {
                        for (var k = 0; k < numOfTicks; k += 1) {
                            var index = Math.round(k*tickIncrem);
                            tickLabArray[index].label = that.qStudioVar.sliderArray[index].label;
                        }
                    } else {
                        if (rowArray[configObj.rowIndex].end_labels) {
                            var rowEndLabels = rowArray[configObj.rowIndex].end_labels.split(","),
                                k = 0, slen = that.qStudioVar.sliderArray.length;

                            if (jQuery.isArray(rowEndLabels) && jQuery.trim(rowEndLabels[0]) !== "" && rowEndLabels.length > 0) {
                                for (k; k < slen; k += 1) {
                                    if (k === 0) {
                                        tickLabArray[k] = { label: rowEndLabels[0], image: that.qStudioVar.sliderArray[k].image };
                                    } else if (k === that.qStudioVar.sliderArray.length - 1) {
                                        tickLabArray[k] = { label: rowEndLabels[1], image: that.qStudioVar.sliderArray[k].image };
                                    }
                                }
                            }
                        }
                    ...
                    tickLabArray = that.qStudioVar.sliderArray;
                }
            ...
            if (!init) {
                ...
                $(document).trigger((!QUtility.isMSTouch()) ?
                    ((!QUtility.isTouchDevice()) ? "mouseup.widget" : "touchend.widget") : ((window.PointerEvent) ? "pointerup.widget" : "MSPointerUp.widget"));
            ...
            for (i = 0; i < rlen; i += 1) {
                ...
                if (init) {
                    ...
                    respRef.push({
                        ...
                        horzContain: undefined,           // Record horz container widget
                        colContain: undefined,             // Record column container widget
                ...
                var sliderParams = this.getColumnSldrParams(true);
                sliderParams.rowIndex = i;
                sliderParams.image = (params.colSldrHndleShowImg.value) ? rowArray[i].image : "";

                // see if we need to set button level params
                this.__setColumnSldrLevelParams(rowObject, sliderParams);

                // set after button level params are set
                sliderParams.tick_array = getTickLabelArray(sliderParams);
                ...
                if (init) {
                    ...
                    respRef[i].horzContain = horzContain;
                    respRef[i].colContain = colContain;
                } else {
                ...
                if (init) {
                    ...
                    if (this._setLayoutCache.contain) {
                        (i !== 0) ?
                            colSldr.enabled((params.rowContainChldInitAlpha.value === 100), params.rowContainChldInitAlpha.value):
                            colSldr.enabled(true);
                    } else {
                        colSldr.enabled(true);
                    }
                    ...
                    // record reference to slider widget
                    respRef[i].column[0] = colSldr;
                    ...
                    colSldr = respRef[i].column[0];
                    // update Column Slider Widget
                    colSldr.config(sliderParams);
                }
                ...
                for (j = 0; j < blen; j += 1) {
                    var colObject = this.qStudioVar.btnArray[j],
                        ...
                        colIndex = jQuery.inArray(colObject, this.qStudioVar.columnArray),
                        colWgt = undefined;
                    ...
                    wgtNameObj.rowIndex = i;
                    wgtNameObj.colIndex = colIndex;
                    wgtNameObj.id = colObject.id || 'col_' + colIndex;
                    ...
                    if (init) {
                        ...
                        colWgt = respRef[i].column[colIndex];
                ...
                if (sliderParams.direction !== "vertical") {
                    ...
                    if (rowSyncTxtBtnHeight && rowBtnType === "text") {
                        rowSyncTxtBtnArray[i] = rowWgt;
                        rowMaxTxtBtnHeight = Math.max(rowMaxTxtBtnHeight, $(rowWgt.cache().nodes.background).height());
                    } else if (!rowSyncTxtBtnHeight && !colSyncTxtBtnHeight) {
                        // Add colContain to horzContain
                        horzContain.add(colContain.container());
            ...
            if (rowSyncTxtBtnHeight || colSyncTxtBtnHeight) {
                for (i = 0; i < rlen; i += 1) {
                    ...
                    var clen = this.qStudioVar.columnArray.length;
                    for (j = 0; j < clen; j += 1) {
                        ...
                        // Add column widget to colContain
                        colContain.add(colWgt, !!this.qStudioVar.columnArray[j].ownRow);

                        // record slider direction
                        if (j === 0) { sliderDirection = colWgt.config().direction; }
                    }
        ...
        __createScrollMatrix: function() {
            ...
            // helper function for column buttons to remove all events
            var cleanup = function(colWgt) {
                if (that.isAutoNextEnabled()) {colWgt.toggleMouseDown(false); }
                var colEle = colWgt.widget();
                $(colEle).off(eventUp);
                $(colEle).off(eventCancel);
                $(doc).off(eventMove);
                $(doc).off(eventUp);
            ...
            $(compContain).on(eventDown, '.qwidget_button', function(event) {
                ...
                if (event.type === "mousedown" || event.type === "touchstart" || event.type === "pointerdown" || event.type === "MSPointerDown") {
                    ...
                    if (that.isAutoNextEnabled()) { col.toggleMouseDown(true); }
                    if (startX !== null && startY !== null) {
                        // touchcancel event
                        $(colEle).on(eventCancel, function(event) {
                            event.stopPropagation();
        ...
        __updateScrollMatrix: function(init) {
            ...
            var getTickLabelArray = function(configObj) {
                ...
                if (overrideTicks) {
                    ...
                    if (sldrTickLabDispType !== "row ends") {
                        ...
                        if (rowArray[curScrollIndex].end_labels) {
                            var rowEndLabels = rowArray[curScrollIndex].end_labels.split(","),
                                k = 0, slen = that.qStudioVar.sliderArray.length;
            ...
            if (!init) {
                ...
                // see if we need to set button level params
                sliderParams.image = (params.colSldrHndleShowImg.value) ? rowArray[curScrollIndex].image : "";
                this.__setColumnSldrLevelParams(rowArray[curScrollIndex], sliderParams);
                // set after button level params are set
                sliderParams.tick_array = getTickLabelArray(sliderParams);

                colSldr = this._scrollLayoutCache.columnWgtArray[0];
                // update Column Slider Widget
                colSldr.config(sliderParams);
            } else {
                // see if we need to set button level params
                sliderParams.image = (params.colSldrHndleShowImg.value) ? rowArray[0].image : "";
                this.__setColumnSldrLevelParams(rowArray[0], sliderParams);
                // set after button level params are set
                sliderParams.tick_array = getTickLabelArray(sliderParams);

                // create slider widget
                colSldr = QStudioCompFactory.widgetFactory(
                    'baseslider',
                    compContain,
                    sliderParams
                );
                ...
                // record reference to slider widget
                this._scrollLayoutCache.columnWgtArray[0] = colSldr;
            ...
            for (j=0; j<blen; j+=1) {
                ...
                if (init) {
                    ...
                    // Store reference of Column Widget for use w/ controller
                    this._scrollLayoutCache.columnWgtArray[colIndex]= colWgt;
                } else {
                    colWgt = this._scrollLayoutCache.columnWgtArray[colIndex];
                    // update Column Button Widget
                    colWgt.config(wgtNameObj);
                }
        ...
        isAutoNextEnabled: function() {
            // auto next works w/ single question type only
        ...
        create: function(parent, surveyContain) {
            ...
            var doc = document,
                ...
                i = 0, clen = columnArray.length,
                btnSliceIndex = -1;

            // create events object
            this.qStudioVar.events = {
                down : (!isMSTouch) ?
                    "mousedown.slidermatrix touchstart.slidermatrix" :
                    ((window.PointerEvent) ? "pointerdown.slidermatrix" : "MSPointerDown.slidermatrix"),
                up : (!isMSTouch) ?
                    "mouseup.slidermatrix touchend.slidermatrix" :
                    ((window.PointerEvent) ? "pointerup.slidermatrix" : "MSPointerUp.slidermatrix"),
                move : (!isMSTouch) ?
                    "touchmove.slidermatrix" :
                    ((window.PointerEvent) ? "pointermove.slidermatrix" : "MSPointerMove.slidermatrix"),
                cancel : (!isMSTouch) ?
                    "touchcancel.slidermatrix" :
                    ((window.PointerEvent) ? "pointercancel.slidermatrix" : "MSPointerCancel.slidermatrix")
            };
            ...
            for (i; i < clen; i += 1) {
                var colWgtType = jQuery.trim(columnArray[i].var1 || columnArray[i].type).toLowerCase();
                if (this.getAcceptedColumnWidgets(colWgtType) === true) {
                    // from this point on assume column objects are buttons
                    this.qStudioVar.btnArray = columnArray.slice(i);
                    btnSliceIndex = i;
                    break;
                }
            }
            ...
            if (btnSliceIndex !== -1) {
                this.qStudioVar.sliderArray = columnArray.slice(0, btnSliceIndex);
                if (!this.qStudioVar.sliderArray.length) {
                    throw new Error("ERROR: No slider widgets present.");
                }
            } else {
                // means we have no buttons
                params.compQuestionType.value = 'Single Choice';
                this.qStudioVar.sliderArray = columnArray;
            }
        ...
        scrollHelper: function() {
            var that = this,
                ...
                enableAlpha = params.rowContainChldEnableAlpha.value,
                enableDelay = params.rowContainScrlAnimSpeed.value,
                clen = colArry.length;
            ...
            for (var i=0; i<clen; i+=1) {
                ...
                if (colWgt) {
                    ...
                    if (colWgt.isOther && colWgt.isOther()) { colWgt.textarea(colWgt.config().other_init_txt); }
            ...
            scrollCache.timeout = setTimeout(function() {
                for (var i=0; i<clen; i+=1) {
                    ...
                    if (colWgt) {
                        ...
                        } else if (rowRespObj.sldrResp.columnValue >= 0 && colWgt === sldr) {
                            colWgt.isAnswered(true, rowRespObj.sldrResp.location, false);
                        }
                    }
                }
                ...
                if (params.colSldrHndleShowImg.value) {
                    sldr._updateHandleImage(rowArray[rowIndex].image);
                }

                // Set slider tick end labels for 'row ends' display type
                if (params.colSldrTickLabDispType.value === "row ends") {
                    var k = 0, slen = that.qStudioVar.sliderArray.length,
                        rowEndLabels = (rowArray[rowIndex].end_labels) ? rowArray[rowIndex].end_labels.split(",") : undefined,
                        editLabel = (jQuery.isArray(rowEndLabels) && jQuery.trim(rowEndLabels[0]) !== "" && rowEndLabels.length > 0),
                        tickLabArray = [];
                    ...
                    sldr._updateTickLabel(tickLabArray);
                }
            }, enableDelay);
        ...
        manageSlide: function(slider, rIndex) {
            ...
            respRef[rowIndex].sldrResp = {
                ...
                location: handleContain[(slider.config().direction.toLowerCase() === 'horizontal') ? "lastX" : "lastY"]
            };
        ...
        setDimenResp: function(respArray) {
            if (jQuery.isArray(respArray) && respArray.length > 0) {
                            ...
                            while (colObj.length !== 0) {
                                ...
                                if (isColIndexValid(rowIndex, colIndex)) {
                                    if (colIndex <= sliderArray.length - 1) {
                                        ...
                                        column.isAnswered(true, (!that.qStudioVar.isCompRTL) ? colIndex : sliderArray.length -  1 - colIndex);
                ...
                if (scrollCache.contain && gotoIndex >= 0) {
                    ...
                    // Set slider handle image
                    if (params.colSldrHndleShowImg.value) {
                        this._scrollLayoutCache.columnWgtArray[0]._updateHandleImage(rowArray[gotoIndex].image);
                    }

                    // Set slider tick end labels for 'row ends' display type
                    if (params.colSldrTickLabDispType.value === "row ends") {
                        var k = 0, slen = that.qStudioVar.sliderArray.length,
                            rowEndLabels = (rowArray[gotoIndex].end_labels) ? rowArray[gotoIndex].end_labels.split(",") : undefined,
                            editLabel = (jQuery.isArray(rowEndLabels) && jQuery.trim(rowEndLabels[0]) !== "" && rowEndLabels.length > 0),
                            tickLabArray = [];
                        ...
                        this._scrollLayoutCache.columnWgtArray[0]._updateTickLabel(tickLabArray);
                    }
                }
            }
        },
