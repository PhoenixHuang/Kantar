...
imagezoom.prototype.getDependencies = function(){
    return [
		...
		{'type':'stylesheet', 'url' : surveyPage.path + 'lib/KO/JetZoom/jetzoom.css'}
    ];
}


imagezoom.prototype.build = function(){
		this.component = $("<div style='text-align:center'><img class='jetzoom' src='"+this.getProperty("Smallimgpath") +"' data-jetzoom = \"zoomImage:'"+this.getProperty("Largeimgpath")+"'\"/> </div>");
