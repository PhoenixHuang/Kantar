...
virtualhighlighter.prototype.getDependencies = function(){
    return [
		...
		{'type':'script', 'url' : surveyPage.path + 'lib/KO/FreehandHighlighter/excanvas.js'}
	];	
}
...
virtualhighlighter.prototype.build = function(){
		...
		this.component = $("<div id='KOFHparent'><center><canvas id='KOFHCanvas' ></canvas><br /><span><input id='KOFHclearBtn' type='button' value='Clear' style='background: #006666;color: #fff;border: solid 2px #FFF;padding-Left: 10px;padding-Right: 10px; padding-Top: 5px;padding-Bottom: 5px; border-Radius: 5px;cursor:pointer; '></input><input id='KOFHnoopnBtn' type='button' value='Noopinion' style='background: #006666;color: #fff;border: solid 2px #FFF;padding-Left: 10px;padding-Right: 10px; padding-Top: 5px;padding-Bottom: 5px; border-Radius: 5px;cursor:pointer; '> </input><input id='KOFHshowGrid' type='button' value='Show Grid' style='background: #006666;color: #fff;border: solid 2px #FFF;padding-Left: 10px;padding-Right: 10px; padding-Top: 5px;padding-Bottom: 5px; border-Radius: 5px; cursor:pointer;'> </input>          </span><br /><textarea id='KOFHdata' cols='50' rows='5'></textarea><textarea name='_QOE' id='_QO' cols='50' rows='5'></textarea></center></div><div id='KOFHpreloader' style='text-align:center;'>Page loading...<img src='"+surveyPage.path +"lib/KO/FreehandHighlighter/preloader.gif' /></div>");
...
virtualhighlighter.prototype.render = function(){
		...
		$('#_QO').hide();
		document.getElementById("survey").style.maxWidth="100%";
