...
clickbasedhighlighter.prototype.build = function(){
		...
		this.component = $("<center> <div id='csPreloader'> Image loading... <div> <img src='"+surveyPage.path+"lib/KO/ClickbasedHighlighter/preloader.gif' id='preloader_image' /> </div> </div> </center>");
