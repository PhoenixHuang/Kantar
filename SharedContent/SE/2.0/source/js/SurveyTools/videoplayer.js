...
videoplayer.prototype.getDependencies = function(){
    return [
		...
		{'type':'script', 'url' : surveyPage.path + 'lib/KO/videoplayer/video.js'},
		{'type':'script', 'url' : surveyPage.path + 'lib/KO/videoplayer/jquery-ui.js'},
		{'type':'script', 'url' : surveyPage.path + 'lib/KO/videoplayer/jquery.ui.touch-punch.js'},
		{'type':'script', 'url' : surveyPage.path + 'lib/KO/videoplayer/videoplayer.js'},
		{'type':'stylesheet', 'url' : surveyPage.path + 'lib/KO/videoplayer/jquery-ui.css'},
		{'type':'stylesheet', 'url' : surveyPage.path + 'lib/KO/videoplayer/video-js.css'},
		{'type':'stylesheet', 'url' : surveyPage.path + 'lib/KO/videoplayer/style_v6.css'}
    ];
}
videoplayer.prototype.build = function(){
		...
		this.component = $("<div id='wrapper'><div id='vidParent' ></div><div id='slider' style='position:relative;width:50%;margin:auto;margin-top:20px;min-width:250px;'><div id='slider-ui' ></div><span id='min' class='tick'></span><span id='mid' class='tick' style='left:50%;'></span><span id='max' class='tick' style='left:100%;'></span></div><div id='playBtn' class='playBtnClass'><img id='playIcon' class='playIconClass' src='"+surveyPage.path +"lib/KO/videoplayer/dummy.gif' width='1' height='1' /><span id='playText' class='playTextClass'>Play</span></div><div style='margin:auto;width:50%;bottom:10px;padding:20px;'><textarea id='output' style='position:relative;top:40px;width:100%;height:60px;'></textarea></div></div>");
		}
...
videoplayer.prototype.render = function(){
		...
		if(videotype == "Normal"){
            ...
            "navbtn":this.getProperty("nextButtonHide"),
        ...
        switch(pageLayout.deviceType.toUpperCase()) {
            ...
            case "SMARTPHONETOUCH":
                return  {	'isSkinRequired' : false,
							'skinImage' : surveyPage.path + "lib/KO/videoplayer/skin.png",
							'top' : 34,
							'left' : 36,
							'right' :35,
							'bottom' : 130,
