    ...
    SliderMatrix.prototype = {
        ...
        initParams: function() {
            return {
                ...
                colSldrTickHide: { name:"Slider Tick: Display", value:true, description:"If set true, slider tick(s) will display.", type:"bool", wgtref: 'colsldr', wgtname:"tick_show", order:80 },
