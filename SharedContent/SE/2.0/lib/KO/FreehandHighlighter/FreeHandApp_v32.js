...
var FreeHandApplication = function(){
	...
	function setProperties()
	{
		...
		imgPath = imageCacheBase+propertiesObj.imgPath+'&#38;'+new Date().getTime(); //Adding Time stamp to the Image url which forces to load from sever
...
//					context.lineJoin = "round";
	...
	function pathStart(e)
	{
		...
		x1 = coordinates[0]-canvasObj.offsetLeft
	...
	function letsStartDraw(e)
	{
		...
		var x = coordinates[0]-canvasObj.offsetLeft
	...
	function updateValues()
	{
		...
		document.getElementsByName(propertiesObj.jsQid)[0].value = data
	}
