...
function VideoPlayer()
{
	...
	function init(props)	{
		...
		if(!properties.nextButtonHide)
		{
			document.getElementById(properties.nextButtonId).style.visibility = "hidden"
		}
	...
	function videoEnded(){
		...
		{
			document.getElementById(properties.nextButtonId).style.visibility = "visible"
			videoNumber = 0;
			if(properties.autosbmt)
