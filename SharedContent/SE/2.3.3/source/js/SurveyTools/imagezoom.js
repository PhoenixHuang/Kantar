...
var compRTL=this.getProperty("compRTL");
		...
		this.component = $("<div style='text-align:"+alignDiv+"'><img class='jetzoom' src='"+this.getProperty("smallImagePath") +"' data-jetzoom = \"zoomImage:'"+this.getProperty("largeImagePath")+"'\"/> </div>");
