    ...
    DragnFlag.prototype = {
        ...
        create: function(parent, surveyContain) {
            ...
            var that = this,
                ...
                curPinSelect = null,
                downEvent = "mousedown.dragnflag touchstart.dragnflag",
                moveEvent = "mousemove.dragnflag touchmove.dragnflag",
                upEvent = "mouseup.dragnflag touchend.dragnflag";
            ...
            slider.style.cssText += ';'.concat("touch-action: none;");
            ...
            if (respRef.dkWgt) {
                var dkEle = respRef.dkWgt.widget(),
                    eventDown = "mousedown.dragnflag touchstart.dragnflag",
                    eventUp = "mouseup.dragnflag touchend.dragnflag",
                    eventMove = "touchmove.dragnflag",
                    touchCoordArray = [];
        ...
        update : function(init) {
            ...
            if (!init) {
                ...
                $(doc).trigger("mouseup.dragnflag touchend.dragnflag");
