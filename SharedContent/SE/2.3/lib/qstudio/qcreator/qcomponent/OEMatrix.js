    ...
    OEMatrix.prototype = {
        ...
        initParams: function() {
            return {
                ...
                colOtherShowLabel: { name:"Column Other: Display Label", value:true, description:"If set false, button label will not display.", type:"bool",  wgtref: 'colbtn', wgtname:"other_show_label", order:60 },
                ...
                colRadChckLabelHoffset: { name:"Column RadChk Btn: Label Left CSS Pos", value:0, description:"Left CSS offset position, in pixels.", type:"number", wgtref: 'colbtn', wgtname:"radchkbtn_label_left", order:54 },
                colRadChckLabelVoffset: { name:"Column RadChk Btn: Label Top CSS Pos", value:0, description:"Top CSS offset position, in pixels.", type:"number", wgtref: 'colbtn', wgtname:"radchkbtn_label_top", order:55 },
                ...
                colKntrInputImpRadio: { name:"Column KantarInput: RADIO Import Bckgrnd", value:"", description:"Import image to use for Radio button types. Only 1 image sprite should be used.", type:"bitmapdata", wgtref: 'colbtn', wgtname:"kntrinputbtn_rad_url", order:75 },
                colKntrInputWidthRadio: { name:"Column KantarInput: RADIO Bckgrnd Width", value:30, description:"Width used for Radio import image, in pixels.", type:"number", min:5, wgtref: 'colbtn', wgtname:"kntrinputbtn_rad_width", order:76 },
                colKntrInputHeightRadio: { name:"Column KantarInput: RADIO Bckgrnd Height", value:30, description:"Height used for Radio import image, in pixels.", type:"number", min:5, wgtref: 'colbtn', wgtname:"kntrinputbtn_rad_height", order:77 },
                colKntrInputImpCheck: { name:"Column KantarInput: CHECK Import Bckgrnd", value:"", description:"Import image to use for Checkbox button types. Only 1 image sprite should be used.", type:"bitmapdata", wgtref: 'colbtn', wgtname:"kntrinputbtn_chk_url", order:78 },
                colKntrInputWidthCheck: { name:"Column KantarInput: CHECK Bckgrnd Width", value:30, description:"Width used for Checkbox import image, in pixels.", type:"number", min:5, wgtref: 'colbtn', wgtname:"kntrinputbtn_chk_width", order:79 },
                colKntrInputHeightCheck: { name:"Column KantarInput: CHECK Bckgrnd Height", value:30, description:"Height used for Checkbox import image, in pixels.", type:"number", min:5, wgtref: 'colbtn', wgtname:"kntrinputbtn_chk_height", order:8 },
                colKntrInputTxtAreaWidth: { name:"Column KantarInput: TextArea Width", value:125, description:"Button textarea input width, in pixels.", type:"number", min:5, wgtref: 'colbtn', wgtname:"kntrinputbtn_input_width", order:72 },
                colKntrInputLabelHalign: { name:"Column KantarInput: Label Horz Alignment", value:'left', description:"Button label horizontal text alignment.", type:"combo", options:['left', 'right', 'center'], wgtref: 'colbtn', wgtname:"kntrinputbtn_label_halign", order:73 },
                colKntrInputLabelWidth: { name:"Column KantarInput: Label Width", value:150, description:"Button label width, in pixels.", type:"number", min:5, wgtref: 'colbtn', wgtname:"kntrinputbtn_label_width", order:72 },
                colKntrInputLabelHoffset: { name:"Column KantarInput: Label Left CSS Pos", value:0, description:"Left CSS offset position, in pixels.", type:"number", wgtref: 'colbtn', wgtname:"kntrinputbtn_label_left", order:54 },
                colKntrInputLabelVoffset: { name:"Column KantarInput: Label Top CSS Pos", value:0, description:"Top CSS offset position, in pixels.", type:"number", wgtref: 'colbtn', wgtname:"kntrinputbtn_label_top", order:55 },
                colKntrInputLabelFontSize: { name:"Column KantarInput: Label Size", value:18, description:"Button label font size, in pixels.", type:"number", min:5, wgtref: 'colbtn', wgtname:"kntrinputbtn_label_fontsize", order:74 },
                colKntrInputLabelColorUp: { name:"Column KantarInput: Label UP Color", value:0x5B5F65, description:"Button label font color in the button’s default state.", type:"colour", wgtref: 'colbtn', wgtname:"kntrinputbtn_label_fontcolor_up", order:56 },
                colKntrInputLabelColorOver: { name:"Column KantarInput: Label OVER Color", value:0x5B5F65, description:"Button label font color on button mouse over.", type:"colour", wgtref: 'colbtn', wgtname:"kntrinputbtn_label_fontcolor_over", order:57 },
                colKntrInputLabelColorDown: { name:"Column KantarInput: Label DOWN Color", value:0x5B5F65, description:"Button label font color when button is selected.", type:"colour", wgtref: 'colbtn', wgtname:"kntrinputbtn_label_fontcolor_down", order:58 },
        ...
        __createDefaultMatrix: function() {
            ...
            var clickHandler = function(row, col) {
                var controllerBool = that.manageClick(col),
                    rowIndex = parseInt(row.widget().getAttribute('rowIndex'), 10),
                    totalWgt = respRef[rowIndex].totalWgt;

                if (typeof controllerBool === 'boolean' && totalWgt) {
                    that.updateRowTotal(rowIndex);
                }
        ...
        create: function(parent) {
            ...
            this.qStudioVar.events = {
                down : (!isMSTouch) ?
                    "mousedown.oematrix touchstart.oematrix" :
                    ((window.PointerEvent) ? "pointerdown.oematrix" : "MSPointerDown.oematrix"),
                up : (!isMSTouch) ?
                    "mouseup.oematrix touchend.oematrix" :
                    ((window.PointerEvent) ? "pointerup.oematrix" : "MSPointerUp.oematrix"),
                move : (!isMSTouch) ?
                    "touchmove.oematrix" :
                    ((window.PointerEvent) ? "pointermove.oematrix" : "MSPointerMove.oematrix"),
                cancel : (!isMSTouch) ?
                    "touchcancel.oematrix" :
                    ((window.PointerEvent) ? "pointercancel.oematrix" : "MSPointerCancel.oematrix")
            };
        ...
        manageClick: function(col, rIndex) {
            ...
            if (col.isOther() && !col.config().allow_click) { return; }
            if (!col.isAnswered()) {
