...
audioplayer.prototype.build = function(){
		...
		if(compRTL == true){
			var alignDiv = " style='direction:ltr;left:auto;'";
		}else{
			var alignDiv = "";	
		}
		var autosubmit = this.getProperty("autoSubmit");
		this.component = $("<div id='wrapper' "+alignDiv+"><audio preload='auto' controls='controls'><source src='"+mp3+"' ></source><source src='"+ogg+"' ></source></audio><script type='text/javascript'>$( function()	{	$('audio' ).audioPlayer({'autosbmt':"+autosubmit+"});});</script></div>");
