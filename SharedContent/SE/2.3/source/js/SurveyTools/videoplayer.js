...
videoplayer.prototype.render = function(){
		...
		if(videotype == "normal"){
            ...
            "slider":{
                ...
                "start":this.getProperty("sliderstarttext"),
                "end":this.getProperty("sliderendtext"),
                "middle":this.getProperty("slidermiddletext")
			},
