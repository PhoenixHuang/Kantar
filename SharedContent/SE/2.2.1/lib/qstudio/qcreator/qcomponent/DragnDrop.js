    ...
    DragnDrop.prototype = {
        ...
        create: function(parent, surveyContain) {
            ...
            var that = this,
                ...
                downEvent = "mousedown.dragndrop touchstart.dragndrop",
                moveEvent = "mousemove.dragndrop touchmove.dragndrop",
                upEvent = "mouseup.dragndrop touchend.dragndrop";
            ...
            if (respRef.dkWgt) {
                var dkEle = respRef.dkWgt.widget(),
                    eventDown = "mousedown.dragndrop touchstart.dragndrop",
                    eventUp = "mouseup.dragndrop touchend.dragndrop",
                    eventMove = "touchmove.dragndrop",
                    touchCoordArray = [];
                ...
                $(dkEle).on(eventDown, function(event) {
                    ...
                    var startX = (event.originalEvent.touches) ? event.originalEvent.touches[0].pageX : null,
                        startY = (event.originalEvent.touches) ? event.originalEvent.touches[0].pageY : null;

                    respRef.dkWgt.toggleMouseEnter(false);
        ...
        update: function(init) {
            ...
            if (!init) {
                ...
                $(document).trigger("mouseup.dragndrop touchend.dragndrop");
            ...
            for (j = 0; j < clen; j += 1) {
                ...
                if (init) {
                    ...
                    colWgt.enabled(true);
                    colWgt.touchEnabled(isTouchDevice);
            ...
            if (respRef.radChkEnabled) {
                ...
                if (init) {
                    ...
                    dkRadChk.touchEnabled(isTouchDevice);
