    ...
    BtnMatrix.prototype = {
        ...
        __createDefaultMatrix: function() {
            ...
            var that = this,
                ...
                eventDown = "mousedown.btnmatrix touchstart.btnmatrix",
                eventUp = "mouseup.btnmatrix touchend.btnmatrix",
                eventMove = "touchmove.btnmatrix",
            ...
            $(compContain).on(txtEvent, '.qwidget_button', function(event) {
                ...
                var controllerBool = that.manageChange(col);
                if (typeof controllerBool === 'boolean' && controllerBool !== row.isAnswered()) {
                    row.isAnswered(controllerBool);
