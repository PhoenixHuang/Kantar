...
dynamiclist.prototype.getDependencies = function(){
    return [
		/*{'type':'script', 'url' : pageLayout.sharedContent+'SE/dev/2.2/lib/KO/DynamicList/jquery.js'},
		{'type':'script', 'url' : pageLayout.sharedContent+'SE/dev/2.2/lib/KO/DynamicList/jquery-1.js'},
		{'type':'script', 'url' : pageLayout.sharedContent+'SE/dev/2.2/lib/KO/DynamicList/jquery_autocomplete.js'},
		{'type':'script', 'url' : pageLayout.sharedContent+'SE/dev/2.2/lib/KO/DynamicList/dynamiclist.js'},
		{'type':'stylesheet', 'url' : pageLayout.sharedContent+'SE/dev/2.2/lib/KO/DynamicList/main.css'}*/
    ];
}
...
dynamiclist.prototype.build = function(){
        $("head").append("<script src="+pageLayout.sharedContent+"SE/dev/2.2/lib/KO/DynamicList/dynamiclist.js><!-- // SE --></script>");
		$("head").append("<script src="+pageLayout.sharedContent+"SE/dev/2.2/lib/KO/DynamicList/jquery.js><!-- // SE --></script>");
		$("head").append("<script src="+pageLayout.sharedContent+"SE/dev/2.2/lib/KO/DynamicList/jquery-1.js><!-- // SE --></script>");
		$("head").append("<script src="+pageLayout.sharedContent+"SE/dev/2.2/lib/KO/DynamicList/jquery_autocomplete.js><!-- // SE --></script>");
		$("head").append("<link rel='stylesheet' type='text/css' href="+pageLayout.sharedContent+"SE/dev/2.2/lib/KO/DynamicList/main.css />");
