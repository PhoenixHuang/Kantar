...
calendar.prototype.getDependencies = function(){
    ...
    return [
	    {'type':'script', 'url' : pageLayout.sharedContent+'LAF/Lib/jQueryUI/jquery-ui.min.js'},
		{'type':'script', 'url' : pageLayout.sharedContent+'LAF/Lib/jquery/jquery.maskedinput-1.2.6-co.min.js'},
		{'type':'stylesheet', 'url' :pageLayout.sharedContent+'LAF/Lib/jQueryUI/jquery-ui.min.css' }
    ];
}
