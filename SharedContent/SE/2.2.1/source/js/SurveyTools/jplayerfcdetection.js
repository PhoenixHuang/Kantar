...
jplayerfcdetection.prototype.getDependencies = function() {
    ...
    if (this.getProperty("technology") == 'flash') {
        return [{
            ...
            'type': 'script',
            'url': surveyPage.path + 'lib/KO/jplayerfcdetection/jw7SetupTimeRate_FC_Flash.js'
        }, {
            "type": "script",
        ...
        s.src = surveyPage.path + "lib/KO/jplayerfcdetection/facerecorder-mrapi.js";
        $("head").append(s);
        ...
        return [{
            ...
            'type': 'script',
            'url': surveyPage.path + 'lib/KO/jplayerfcdetection/jw7SetupTimeRate_FC.js'
        }, {
            "type": "script",
            "url": pageLayout.sharedContent + "LAF/Lib/jplayeriosfix/ios-orientation-fix.min.js"
        }, {
            ...
            "type": "script",
            "url": surveyPage.path + "lib/KO/jplayerfcdetection/affectiva_v5.js"
        }, {
            "type": "stylesheet",
...
jplayerfcdetection.prototype.render = function() {
    ...
    for (ii = 0; ii < totalVideos.length; ii++) {
        ...
        var checkMultimedia = url.indexOf("multimedia");
        ...
        if (checkMultimedia < 0) {
            if (this.getProperty("ischina")) {
                ...
                if (window.location.protocol == "https:") {
                    ...
                    source["sources"].push({
                        "file": "https://16f8b.https.cdn.softlayer.net/8316F8B/" + url + ".m3u8"

                    });
					
                } else {
                    source["sources"].push({
                        "file": "http://16f8b.http.cdn.softlayer.net/8316F8B/" + url + ".m3u8"
                ...
                if (window.location.protocol == "https:") {
                    source["sources"].push({
                        "file": "https://16f8b.https.cdn.softlayer.net/8016F8B/" + url
                    });
                } else {
                    source["sources"].push({
                        "file": "http://16f8b.http.cdn.softlayer.net/8016F8B/" + url
                    });
                }
            }
     	 } 	else {
            ...
            if (this.getProperty("ischina")) {
				if (window.location.protocol == "https:") {
					source["sources"].push({
						"file": "https://cdn.tns-global.com/" + url
