 ...
 *   - getAcceptedRowWidgets: Returns an array listing the accepted row button widgets. Optionally pass a string argument to see if it's a valid button type
    ...
    RowPicker.prototype = {
        ...
        create: function(parent) {
            ...
            var that = this,
                ...
                eventStr = (!isMSTouch) ?
                    ((!isTouchDevice) ? "click.rowpicker" : "touchstart.rowpicker touchend.rowpicker touchmove.rowpicker"):
                    ((!isTouchDevice) ? "click.rowpicker" : ((window.PointerEvent) ? "pointerdown.rowpicker pointerup.rowpicker" : "MSPointerDown.rowpicker MSPointerUp.rowpicker")),
