 ...
 *
 * Release 1.3.0
 * - Added a new row button widget, 'Flow'.
 ...
 *   - getColumnBucketParams: Returns an object listing all the column bucket level parameters.
 ...
 * - Added a new string parameter, compPrimRowFontFamily, which you can use to set a row primary font family
 * - Added a new string parameter, compPrimColumnFontFamily, which you can use to set a column primary font family
 * - Removed numeric parameter, colDzoneBorderWidth. Instead added numeric parameters, colDzoneBorderWidthUp and colDzoneBorderWidthOver, allowing you to set the border width for each bucket state.
 * - Removed numeric parameter, rowKantBtnLabelWidth. This value is now inherited from rowBtnWidth
 * - Removed numeric parameter, rowBtnMouseDownAlpha. The parameter was only being applied to 'anchor' bucket animation and can also conflict w/ rowBtnDragAlpha parameter.
 * - You can now include a RadioCheck button widget, which will act like a 'Don't Know' option, to accompany the column buckets.
 *   This widget will use the last column object of the columnArray when constructing.
 *   The following are a list of new parameters to support this feature.
 *    - Added a new boolean parameter, colRadChckEnable, which when set true will include a 'Don't Know' option using the last column object of the columnArray
 *    - Added a new string parameter, colRadChckImp, which you can use to import a custom background sprite image to use for the radio button
 *    - Added a new numeric parameter, colRadChckWidth, which you can use to set the radio button background width, in pixels
 *    - Added a new numeric parameter, colRadChckHeight, which you can use to set the radio button background height, in pixels
 *    - Added a new numeric parameter, colRadChckHoffset, which you can use to offset the radio button widget left position, in pixels
 *    - Added a new numeric parameter, colRadChckVoffset, which you can use to offset the radio button widget top position, in pixels
 *    - Added a new string parameter, colRadChckLabelHalign, which you can use to set the radio button label horizontal alignment
 *    - Added a new numeric parameter, colRadChckLabelWidth, which you can use to set the radio button label width, in pixels
 *    - Added a new numeric parameter, colRadChckLabelFontSize, which you can use to set the radio button label font size, in pixels
 *    - Added a new color parameter, colRadChckLabelColorUp, which you can use to set the radio button label color on the button UP state
 *    - Added a new color parameter, colRadChckLabelColorOver, which you can use to set the radio button label color on the button OVER state
 *    - Added a new color parameter, colRadChckLabelColorDown, which you can use to set the radio button label color on the button DOWN state
 * - Bucket overlay labels will now adjust the bucket height accordingly and not encroach on other bucket content. This means bucket heights will be larger when label placement is of an overlay type.
 * - Introduced rowColIndex property for setDimenResp method which applies to 'Multi' question type. The rowColIndex property should reference a valid row column index.
 *
 */
    ...
    DragnDrop.prototype = {
        ...
        initParams: function() {
            return {
                ...
                colRadChckEnable: { name:"Column RadChk: Enable", value:false, description:"If set true, last columnArray object will be used to create a RadioCheck widget button.", type:"bool", order:60 },
                colRadChckImp: { name:"Column RadChk: Import Bckgrnd", value:"", description:"Import image to use for button. Only 1 image sprite should be used.", type:"bitmapdata", wgtref: 'dkbtn', wgtname:"radchkbtn_rad_url", order:75 },
                colRadChckWidth: { name:"Column RadChk: Bckgrnd Width", value:30, description:"Width used for import image, in pixels.", type:"number", min:5, wgtref: 'dkbtn', wgtname:"radchkbtn_rad_width", order:76 },
                colRadChckHeight: { name:"Column RadChk: Bckgrnd Height", value:30, description:"Height used for import image, in pixels.", type:"number", min:5, wgtref: 'dkbtn', wgtname:"radchkbtn_rad_height", order:77 },
                colRadChckHoffset: { name:"Column RadChk: Left CSS Pos", value:0, description:"Left CSS offset position, in pixels.", type:"number", wgtref: 'dkbtn', wgtname:"left", order:112 },
                colRadChckVoffset: { name:"Column RadChk: Top CSS Pos", value:0, description:"Top CSS offset position, in pixels.", type:"number", wgtref: 'dkbtn', wgtname:"top", order:113 },
                colRadChckLabelHalign: { name:"Column RadChk: Label Horz Alignment", value:'left', description:"Button label horizontal text alignment.", type:"combo", options:['left', 'right', 'center'], wgtref: 'dkbtn', wgtname:"radchkbtn_label_halign", order:73 },
                colRadChckLabelWidth: { name:"Column RadChk: Label Width", value:100, description:"Button label width, in pixels.", type:"number", min:5, wgtref: 'dkbtn', wgtname:"radchkbtn_label_width", order:72 },
                colRadChckLabelFontSize: { name:"Column RadChk: Label Font Size", value:18, description:"Button label font size, in pixels.", type:"number", min:5, wgtref: 'dkbtn', wgtname:"radchkbtn_label_fontsize", order:74 },
                colRadChckLabelColorUp: { name:"Column RadChk: Label UP Font Color", value:0x5B5F65, description:"Button label font color in the button’s default state.", type:"colour", wgtref: 'dkbtn', wgtname:"radchkbtn_label_fontcolor_up", order:56 },
                colRadChckLabelColorOver: { name:"Column RadChk: Label OVER Font Color", value:0x5B5F65, description:"Button label font color on button mouse over.", type:"colour", wgtref: 'dkbtn', wgtname:"radchkbtn_label_fontcolor_over", order:57 },
                colRadChckLabelColorDown: { name:"Column RadChk: Label DOWN Font Color", value:0x5B5F65, description:"Button label font color when button is selected.", type:"colour", wgtref: 'dkbtn', wgtname:"radchkbtn_label_fontcolor_down", order:58 },
        ...
        create: function(parent, surveyContain) {
            ...
            var that = this,
                ...
                downEvent = (!isMSTouch) ? ((isTouchDevice) ? "touchstart.dragndrop" : "mousedown.dragndrop") :
                    ((isTouchDevice) ? ((window.PointerEvent) ? "pointerdown.dragndrop" : "MSPointerDown.dragndrop") : "mousedown.dragndrop"),
                moveEvent = (!isMSTouch) ? ((isTouchDevice) ? "touchmove.dragndrop" : "mousemove.dragndrop") :
            ...
            if (params.compQuestionType.value.toLowerCase() === "restrict" && this.qStudioVar.isDC && dcProxy) {
                var navBtnEvent = (!isMSTouch) ?
                        ((!isTouchDevice) ? "click.dragndrop mousedown.dragndrop" : "touchstart.dragndrop touchend.dragndrop touchmove.dragndrop"):
                        ((!isTouchDevice) ? "click.dragndrop mousedown.dragndrop" : ((window.PointerEvent) ? "pointerdown.dragndrop pointerup.dragndrop" : "MSPointerDown.dragndrop MSPointerUp.dragndrop")),
                    qsIsTouchMove = false;
            ...
            if (respRef.dkWgt) {
                var eventStr = (!isMSTouch) ?
                        ((!isTouchDevice) ? "click.dragndrop" : "touchstart.dragndrop touchend.dragndrop touchmove.dragndrop"):
                        ((!isTouchDevice) ? "click.dragndrop" : ((window.PointerEvent) ? "pointerdown.dragndrop pointerup.dragndrop" : "MSPointerDown.dragndrop MSPointerUp.dragndrop")),
                    isTouchMove = false;
                $(respRef.dkWgt.widget()).on(eventStr, function(event){
                    event.stopPropagation();
                    if (isMSTouch && isTouchDevice && !event.originalEvent.isPrimary) { return; }
                    if (event.type !== "touchmove") {
                        if (event.type !== 'touchstart' && event.type !== "pointerdown" && event.type !== "MSPointerDown") {
                            if (!isTouchMove) { that.manageClick(); }
                        } else {
                            isTouchMove = false;
                        }
                    } else {
