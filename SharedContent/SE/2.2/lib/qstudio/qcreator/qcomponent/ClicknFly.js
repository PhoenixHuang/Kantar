    ...
    ClicknFly.prototype = {
        ...
        initParams: function() {
            return {
                ...
                dkRadChckEnable: { name:"Row RadChk: Enable", value:false, description:"If set true, last rowArray object will be used to create a RadioCheck widget button.", type:"bool", order:60 },
                dkRadChckImp: { name:"Row RadChk: Import Bckgrnd", value:"", description:"Import image to use for button. Only 1 image sprite should be used.", type:"bitmapdata", wgtref: 'dkbtn', wgtname:"radchkbtn_rad_url", order:75 },
                dkRadChckWidth: { name:"Row RadChk: Bckgrnd Width", value:30, description:"Width used for import image, in pixels.", type:"number", min:5, wgtref: 'dkbtn', wgtname:"radchkbtn_rad_width", order:76 },
                dkRadChckHeight: { name:"Row RadChk: Bckgrnd Height", value:30, description:"Height used for import image, in pixels.", type:"number", min:5, wgtref: 'dkbtn', wgtname:"radchkbtn_rad_height", order:77 },
                dkRadChckLabelHalign: { name:"Row RadChk: Label Horz Alignment", value:'left', description:"Button label horizontal text alignment.", type:"combo", options:['left', 'right', 'center'], wgtref: 'dkbtn', wgtname:"radchkbtn_label_halign", order:73 },
                dkRadChckLabelWidth: { name:"Row RadChk: Label Width", value:100, description:"Button label width, in pixels.", type:"number", min:5, wgtref: 'dkbtn', wgtname:"radchkbtn_label_width", order:72 },
                dkRadChckLabelFontSize: { name:"Row RadChk: Label Font Size", value:18, description:"Button label font size, in pixels.", type:"number", min:5, wgtref: 'dkbtn', wgtname:"radchkbtn_label_fontsize", order:74 },
                dkRadChckLabelColorUp: { name:"Row RadChk: Label Font Color", value:0x5B5F65, description:"Button label font color.", type:"colour", wgtref: 'dkbtn', wgtname:"radchkbtn_label_fontcolor_up", order:56 },
                ...
                rowBtnLabelPlacement: { name:"Row Label: Placement", value:'bottom', description:"Button label placement.", type:"combo", options:['top', 'bottom', 'bottom overlay', 'top overlay'], wgtref: 'rowbtn', wgtname:"label_placement", order:51 },
        ...
        create: function(parent) {
            ...
            var that = this,
                ...
                eventStr = (!isMSTouch) ?
                    ((!isTouchDevice) ? "click.clicknfly" : "touchstart.clicknfly touchend.clicknfly touchmove.clicknfly"):
                    ((!isTouchDevice) ? "click.clicknfly" : ((window.PointerEvent) ? "pointerdown.clicknfly pointerup.clicknfly" : "MSPointerDown.clicknfly MSPointerUp.clicknfly")),
                isTouchMove = false;
            ...
            $(compContain).on(eventStr, ".qwidget_button", function(event) {
                ...
                if (event.type !== "touchmove") {
                    if (event.type !== 'touchstart' && event.type !== "pointerdown" && event.type !== "MSPointerDown") {
                        ...
                        that[(params.compQuestionType.value.toLowerCase().indexOf("single") !== -1) ? "controllerTapSingle" : "controllerTapMulti"](rowIndex);
                    } else {
                        isTouchMove = false;
                    }
                } else {
        ...
        controllerTapSingle : function(rowIndex, animTime, fromDK) {
            ...
            if (curRowResp) {
                ...
                this.sendResponse(respRef.dkWgt.rowIndex(), false);
            }
