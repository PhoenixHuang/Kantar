 ...
 *   - getColumnSldrParams: Returns an object listing all the column slider level parameters.
 ...
 * - Added a new string parameter, colSldrBorderStyle, which you can use to set the slider widget border style
 * - Added a new numeric parameter, colSldrBorderWidth, which you can use to set the slider widget border width
 * - Added a new color parameter, colSldrBorderColor, which you can use to set the slider widget border color
 * - Added a new boolean parameter, colSldrShowLabelBckgrnd, which you can use to toggle the display of the slider widget label background color
 * - Added a new color parameter, colSldrLabelBckgrndColor, which you can use to set the slider widget label background color
 ...
 * - Re-enabled numeric parameter, colSldrHndleLabWidth, as the handle label width is now a fixed value
    ...
    SliderMatrix.prototype = {
        ...
        initParams: function() {
            return {
                ...
                colSldrTickLabCustomCnt: { name:"Slider Tick: Custom Label Count", value:5, description:"Number of tick labels to display on slider track. Applies to 'custom' tick label display type only.", type:"number", min:1, order:36 }, //excluded
        ...
        __createDefaultMatrix: function() {
            ...
            var that = this,
                ...
                eventStr = (!isMSTouch) ?
                    ((!isTouchDevice) ? "click.slidermatrix" : "touchstart.slidermatrix touchend.slidermatrix touchmove.slidermatrix"):
                    ((!isTouchDevice) ? "click.slidermatrix" : ((window.PointerEvent) ? "pointerdown.slidermatrix pointerup.slidermatrix" : "MSPointerDown.slidermatrix MSPointerUp.slidermatrix")),
