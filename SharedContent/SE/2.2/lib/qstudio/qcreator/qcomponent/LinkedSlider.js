...
var LinkedSlider = (function () {
    ...
    LinkedSlider.prototype = {
        ...
        __updateGoogleChart: function() {
            ...
            // update chartContain
            rowContain.container().style.display = "";  // reset
            chartContain.style.display = "";        // reset
            chartContain.style.verticalAlign = "";  // reset
            ...
            switch (params.chartPosition.value.toLowerCase()) {
                case "top" :
                ...
                case "right" :
                    ...
                    chartContain.style.display = "inline-block";
                    chartContain.style.verticalAlign = "top";
                    chartContain.style.height = rowContainHeight + "px";
                    rowContain.container().style.display = "inline-block";
                    compContain.appendChild(chartContain);
                    break;
                default :
                    respRef.chartConfigObj.width -= chartPadding * 2;
        ...
        create: function(parent, surveyContain) {
            ...
            var that = this,
                ...
                eventStr = (!isMSTouch) ?
                    ((!isTouchDevice) ? "click.linkedslider" : "touchstart.linkedslider touchend.linkedslider touchmove.linkedslider"):
                    ((!isTouchDevice) ? "click.linkedslider" : ((window.PointerEvent) ? "pointerdown.linkedslider pointerup.linkedslider" : "MSPointerDown.linkedslider MSPointerUp.linkedslider")),
            ...
            $(compContain).on(eventStr, '.qwidget_button', function(event) {
                ...
                if ((!row.enabled()) || (isMSTouch && isTouchDevice && !event.originalEvent.isPrimary) || that.qStudioVar.isUpdating) { return; }
