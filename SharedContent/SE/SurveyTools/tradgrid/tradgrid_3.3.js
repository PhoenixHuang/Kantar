...
tradgrid.prototype.build = function() {
    ...
    if (this.getProperty("answertype") != null) {
        ...
        function loadrules() {
            ...
            var fnstring = "tg_" + that.getProperty("answertype").replace(/-/g, "_");
            ...
            var updateOptions = function(data) {
                ...
                $.extend(true, that.options, surveyPage.themeRuleSetprops.tradgrid);
...
tradgrid.prototype.toolOptions = function() {
    $.extend(this.options, this.options.tradgrid);
    return {
        row: {
            basecolor: "#d9d9d9",
            captype: 'none',
