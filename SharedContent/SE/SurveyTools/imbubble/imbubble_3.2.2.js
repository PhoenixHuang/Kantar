...
imbubble.prototype.getDependencies = function() {
    return [{
            ...
            'type': 'stylesheet',
            'url' : surveyPage.path + 'lib/KO/imbubble/1.0/css/customstyles.css'
        }, {
            'type': 'stylesheet',
