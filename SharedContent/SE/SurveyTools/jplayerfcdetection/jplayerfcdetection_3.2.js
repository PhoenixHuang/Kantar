...
jplayerfcdetection.prototype.getDependencies = function() {
	...
	if(facerecording){
		...
		return [{
			...
			"type": "stylesheet",
			"url": surveyPage.path + "lib/KO/jplayerfcdetection/1.1/affectiva_v5.css"
		}, {
			"type": "script",
			...
			'type': 'script',
			'url': surveyPage.path + 'lib/KO/jplayerfcdetection/1.1/jw7SetupTimeRate_FC.js'
		}, {
			"type": "script",
...
jplayerfcdetection.prototype.toolOptions = function() {
    ...
    return {
        ...
        'instructionstxt': 'Select \'Allow\' to begin.<p/>Your face should fill the oval and be well lit from the front.<p/>Avoid having other people in the frame while the webcam is recording.<p/>Select \'Continue\' when you are ready.',
