/**
 * qcbtnmatrixgrid class
 * Inherits from SESurveyTool
 */
function qcbtnmatrixgrid(questionContainers, json, globalOpts) {
    SESurveyTool.prototype.init.call(this, questionContainers, json, globalOpts);
}
qcbtnmatrixgrid.prototype = Object.create(SESurveyTool.prototype);
qcbtnmatrixgrid.prototype.type = function(){
    return "qcbtnmatrixgrid";
}
qcbtnmatrixgrid.prototype.getDependencies = function(){
    return [
...
qcbtnmatrixgrid.prototype.setInitialResponses = function (){
    var dimResp = [];
...
qcbtnmatrixgrid.prototype.setResponses = function (){
...
qcbtnmatrixgrid.prototype.build = function(){
...
qcbtnmatrixgrid.prototype.toolOptions = function() {
        $.extend(this.options, eval("this.options."+qcbtnmatrixgrid.prototype.type()));
