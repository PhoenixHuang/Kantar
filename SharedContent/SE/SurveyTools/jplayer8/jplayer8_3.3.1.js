...
jplayer8.prototype.getDependencies = function() {
	var jwplayerpath = pageLayout.sharedContent + "LAF/Lib/jwPlayer/8.17.1/jwplayer.js";
	if(this.getProperty("cdndomain").toLowerCase() === "cdn.ktrmr.cn"){
		 jwplayerpath = pageLayout.sharedContent + "LAF/Lib/jwPlayer/8.17.1/jwplayer_china.js";
	}
    ...
    return [{
            ...
            'type': 'script',
            'url': surveyPage.path + 'lib/KO/jwplayer/1.7/jwplayer8.js'
        },
        {
            "type": "stylesheet",
...
jplayer8.prototype.render = function() {
    ...
    if (device == "LARGETABLET" || device == "MEDIUMTABLET" || device == "SMALLTABLET" || device == "SMARTPHONETOUCH") {
         width = this.getProperty("devicewidth");
    }
    ...
    if (filetype == 'audio') {
        props = {
			...
			"hlsport": this.getProperty("hlsport"),
			"cdndomain": this.getProperty("cdndomain"),
			"origindomain": this.getProperty("origindomain"),
			"urlcheck": this.getProperty("urlcheck"),
			"othercdn": this.getProperty("othercdn"),
			"othercdnurl": this.getProperty("othercdnurl"),
				"watermarkhide": this.getProperty("watermarkhide"),
				"watermarkfile": this.getProperty("watermarkfile"),
				"watermarkposition": this.getProperty("watermarkposition"),
				"watermarkmargin": this.getProperty("watermarkmargin"),
				"watermarklink": this.getProperty("watermarklink")
        }
