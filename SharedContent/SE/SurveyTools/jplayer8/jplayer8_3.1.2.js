...
jplayer8.prototype.getDependencies = function() {
    return [{
            ...
            'type': 'script',
            'url': surveyPage.path + 'lib/KO/jwplayer/1.3/jwplayer8.js'
        },
        {
            "type": "stylesheet",
...
jplayer8.prototype.build = function() {
	...
	$('head').append("<style>.jwplayer{display: inline-block !important;} .slidertext{width: 31.333%;display: table-cell;}</style>");
	if (videotype == "slider") {
