        ...
        onSelect: function(selectArray, mandBool) {
            ...
            if (captype == 'min') {
                ...
                jQuery.each(selectArray, function(i, val) {
					if(val.length > 0){
						if (val.length >= capvalue || (typeof val[0] != "undefined" && val[0].isRadio)) {
							captypecount++;
						}
					}
                });
...
gridmatrix.prototype.pagination = function(rowArray) {
    if (this.options.rowGrid.extrasmall.gridtype == "pagination" && window.matchMedia('(min-width:0px) and (max-width: 543px)').matches)
        this.bindNavigations(rowArray);
    if (this.options.rowGrid.small.gridtype == "pagination" && window.matchMedia('(min-width:544px) and (max-width: 767px)').matches)
        this.bindNavigations(rowArray);
    if (this.options.rowGrid.medium.gridtype == "pagination" && window.matchMedia('(min-width:768px) and (max-width: 991px)').matches)
        this.bindNavigations(rowArray);
    if (this.options.rowGrid.large.gridtype == "pagination" && window.matchMedia('(min-width:992px) and (max-width: 1199px)').matches)
        this.bindNavigations(rowArray);
    if (this.options.rowGrid.extralarge.gridtype == "pagination" && window.matchMedia('(min-width:1200px)').matches)
        this.bindNavigations(rowArray);
}



gridmatrix.prototype.navNextButton = function() {
...
gridmatrix.prototype.navPrevButton = function() {
...
gridmatrix.prototype.bindNavigations = function(rowArray) {
	console.log("bindNavigations");
...
this.toolParams.next = document.getElementById("dgNext");
    this.toolParams.back = document.getElementById("dgPrev");
    this.toolParams.onNavSelect = function(scrollIndex) {
