...
mediaupload.prototype.render = function() {
    ...
    $('#' + fileId).change({
        ...
        if (selectedfile != undefined) {
            ...
            if (mediatype == 'image' && imageType == null) {
                pageLayout.hideLoader();
                componentContainer.find('.mrErrorText').remove();
                componentContainer.prepend("<span class=\"mrErrorText\">" + imagemediatypeerrmsg + "<br/></span>");
            }else if(mediatype == 'audio' && audioType == null){
				pageLayout.hideLoader();
                componentContainer.find('.mrErrorText').remove();
                componentContainer.prepend("<span class=\"mrErrorText\">" + audiomediatypeerrmsg + "<br/></span>");
			}else if(mediatype == 'video' && videoType == null){
				pageLayout.hideLoader();
                componentContainer.find('.mrErrorText').remove();
                componentContainer.prepend("<span class=\"mrErrorText\">" + videomediatypeerrmsg + "<br/></span>");
			} else {
