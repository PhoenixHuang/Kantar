 ...
 magazine.prototype.getDependencies = function() {
	 if(this.getProperty("largebuttons")){
		...
		return [{
			...
			'type': 'script',
			'url': surveyPage.path + 'lib/KO/Magazine/1.1/lib/datacapture.js'
		 }];
 ...
 magazine.prototype.render = function() {
	 ...
	 $("#nextButton").on('click touchstart',function(){pageLayout.showLoader();pageLayout.next.click()});
	 if(this.getProperty("largebuttons")){
		  $("#nextButton").css({"float":"right","margin-top": "24px",  "background-color":"#000","color":"#fff","border":"0px","font-size":"24px"});
	 }else{
 ...
 magazine.prototype.toolOptions = function() {
     $.extend(this.options, this.options.magazine);
