...
rowrank.prototype.build = function() {
    ...
    if (this.getProperty("answertype") != null) {
        ...
        function loadrules() {
            ...
            var fnstring = "rr_" + that.getProperty("answertype").replace(/-/g, "_");
            ...
            var updateOptions = function(data) {
                ...
                $.extend(true, that.options, surveyPage.themeRuleSetprops.rowrank);
...
rowrank.prototype.toolOptions = function() {
    $.extend(this.options, this.options.rowrank);
    return {
        row: {
            animtype: 'bottom',
            uitype: "stamp",
