...
rankinggrid.prototype.setResponses = function (){
    ...
    $.each($(response.Value), function(i,e) {
        ...
        //Fix for response missing on orientation change		
		if(typeof surveyPlatform =="undefined"&&pageLayout.deviceType.toUpperCase()!=="PC"){     // This code only for Dimensions
			that.subquestions[rowId].inputs[0].attributes[7].value=$.makeArray(resp);
		}
    });
