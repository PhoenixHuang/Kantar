...
calendar.prototype.build = function() {
    ...
    if (DeviceType == "PC" || DeviceType == "OTHERDEVICE") {
        ...
        $("<style>input[type=text]{z-index:99999}.md-form label{left:0.8rem;} .picker__weekday-display{background-color:" + calendarweekdaydisplay + "} .picker__date-display{background-color:" + calendardatedisplay + "}.picker--focused .picker__day--selected, .picker__day--selected, .picker__day--selected:hover{background-color:" + calendardayselected + "} .picker__button--today:before{border-top:.66em solid " + calendarbuttontoday + "}</style>").appendTo("head")
        ...
        if (detectIE() == false && customcalendar == false) {
            ...
            $("<style>.md-form label{left:0.8rem;} .picker__weekday-display{background-color:" + calendarweekdaydisplay + "} .picker__date-display{background-color:" + calendardatedisplay + "}.picker--focused .picker__day--selected, .picker__day--selected, .picker__day--selected:hover{background-color:" + calendardayselected + "} .picker__button--today:before{border-top:.66em solid " + calendarbuttontoday + "}</style>").appendTo("head")
...
calendar.prototype.render = function() {
        ...
        if (DeviceType == "PC" || DeviceType == "OTHERDEVICE") {
            ...
            $('.datepicker').pickadate({
				...
				disable:disable,
					onOpen: function() {
						$( 'input[type=text]' ).css("z-index","99");
					},
					onClose: function() {
