...
dragnflag.prototype.build = function() {
    ...
    if (this.getProperty("answertype") != null) {
        ...
        function loadrules() {
            ...
            var fnstring = "df_" + that.getProperty("answertype").replace(/-/g, "_");
            ...
            var updateOptions = function(data) {
                ...
                $.extend(true, that.options, surveyPage.themeRuleSetprops.dragnflag);
...
dragnflag.prototype.toolOptions = function() {
    $.extend(this.options, this.options.dragnflag);
    return {
        row: {
            uitype: "img pin",
            animtype: 'bottom',
