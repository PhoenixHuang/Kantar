...
toggle.prototype.render = function(){
        ...
        componentContainer.append(this.label);
        componentContainer.attr('id','qc_'+this.questionFullName); //change to be more identifable with question?
        componentContainer.addClass('qcContainer');
        ...
        componentContainer.append(this.component);
		this.nativeContainer.after(componentContainer);
