...
slider.prototype.build = function(){
        ...
        $.each(this.inputs.filter(":checkbox,:radio"), function (i, e) {
            ...
            colArray.push({
                id: el.attr('value'),
                label: (sldr.slidertype == 'categorical')?label.html():label.eq(i).html(),
                description: (sldr.slidertype == 'categorical')?label.text():label.eq(i).text(),
