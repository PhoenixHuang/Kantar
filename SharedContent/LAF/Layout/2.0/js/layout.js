...
layout.prototype = {
    ...
    v3Styles: function() {
		...
		$('.mrEdit').css('margin-bottom','0.5rem');
		var vc=0;
        ...
        questions.find("input[type='checkbox']").change(function() {
            ...
            // DK, None of these
            if (isexclusive == "true") {
                questions.find('input[type="checkbox"][questionname="' + questionname + '"]').attr('checked', false);
                questions.find('input[type="checkbox"][questionname="' + questionname + '"]').prop('checked', false);
        ...
        $("input[type='text'][otherinput='true']").keyup(function() {
            ...
            if (inputlen.length > 0) {
                $("input[questionname='" + questionName + "'][otherid]:not([otherid=''])").prop('checked', true);
                $("input[questionname='" + questionName + "'][otherid]:not([otherid=''])").attr('checked', true);
                ...
                $("input[questionname='" + questionName + "'][otherid]:not([otherid=''])").prop('checked', false);
                $("input[questionname='" + questionName + "'][otherid]:not([otherid=''])").attr('checked', false);
            }
        });

        $("td[id^='Cell.']").click(function() {
            $(this).find("input[type='radio'][otherid='']").prop('checked', true);
            if ($(this).find("input[type='checkbox'][otherid='']").prop('checked')) {
                $(this).find("input[type='checkbox'][otherid='']").prop('checked', false)
            } else {
                $(this).find("input[type='checkbox'][otherid='']").prop('checked', true)
            }
        });
        ...
        if (cells.length > 2) {
            cells.each(function() {
                ...
                if ($(this).children('input').attr("otherid") != "") {
                    ...
                    $(this).find('.md-form').attr('style', 'margin-bottom: 0 !important; margin-top: 1.5rem !important');
                    $(this).find('.md-form label').attr('style', 'padding: 0 !important; text-align:left;');
                }
